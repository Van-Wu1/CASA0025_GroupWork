...
function renderWaterBodyTable(yearL, valL, yearR, valR) {
  ...
  var headerRow = ui.Panel({
    ...
    widgets: [
      ui.Label('', {width: '70px'}),
      ui.Label(yearL, {width: '90px', textAlign: 'center'}),
      ui.Label(yearR, {width: '90px', textAlign: 'center'}),
      ui.Label('Difference', {width: '90px', textAlign: 'center', fontWeight: 'bold'})
    ]
  });
  ...
  function row(label, v1, v2) {
    return ui.Panel({
      ...
      widgets: [
        ...
        ui.Label(v1 + ' km²', {width: '90px'}),
        ui.Label(v2 + ' km²', {width: '90px'}),
